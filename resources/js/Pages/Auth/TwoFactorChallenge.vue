...
<template>
    ...
    <AuthenticationCard>
        ...
        <template #illustration>
            <p class="text-3xl"><b>Two-factor</b> Confirmation</p>
        ...
        <form @submit.prevent="submit">
            <div v-if="!recovery">
                ...
                <TextInput id="code" ref="codeInput" v-model="form.code" type="text" inputmode="numeric"
                    class="mt-1 block w-full" autofocus autocomplete="one-time-code" placeholder="Code" />
            ...
            <div v-else>
                ...
                <TextInput id="recovery_code" ref="recoveryCodeInput" v-model="form.recovery_code" type="text"
                    class="mt-1 block w-full" autocomplete="one-time-code" placeholder="Recovery Code" />
